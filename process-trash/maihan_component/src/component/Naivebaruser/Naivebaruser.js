...
import '../../css/Naivebaruser.css'
const naivebaruser = props =>(
    <header>
        <div className='naivebaruser'>
        <nav className='naivebar_user'>
        <ul className='userbar_1'>
                <li><a href='/'><strong>CREATED</strong></a></li>
                <li><a href='/'><strong>COLLECTED</strong></a></li>
                <li><a href='/'><strong>FAVORITED</strong></a></li>
